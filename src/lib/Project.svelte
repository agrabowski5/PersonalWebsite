<script>
    ...
    // Primary link: website if available, otherwise github
    $: primaryLink = data.website || data.github || null;
</script>

<article>
    <a href={primaryLink} target="_blank" rel="noopener noreferrer" class="card-link" class:no-link={!primaryLink}>
    ...
    {#if data.github || data.website}
        <div class="project-links">
            {#if data.website}
                <a href={data.website} target="_blank" rel="noopener noreferrer" class="project-link website" on:click|stopPropagation>
            ...
            {/if}
            {#if data.github}
                <a href={data.github} target="_blank" rel="noopener noreferrer" class="project-link github" on:click|stopPropagation>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
